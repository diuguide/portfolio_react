        ...
        <div className="row justify-content-center">
            <div class="col">
                ...
                <div className="row">
                    <div className="col m-1 p-3 rounded shadow bg-light">
                        <p>     Hello there!
                       Thank you for taking the time to visit my portfolio, here you will find links to all of my work in addition to links to my social media and professional accounts/repositories.  Please feel free to shoot me an email if you have any questions!</p>
                       <p className="float-right">- Everett</p>
                    </div>
                </div>
            </div>
        </div>
