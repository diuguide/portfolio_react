            ...
            <div class="col">
                <div className="row">
                    <div className="col m-1 shadow bg-light rounded">
                        ...
                        <div className="p-2">I am a Web developer with a background in Hospitality and Communication. I have a proven ability to focus on the
                ...
                building a better web-experience. </div>
