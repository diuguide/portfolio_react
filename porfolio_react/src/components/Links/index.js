...
function Links() {
    return (
        <div className="col-sm col-md-4 col-lg-3 bg-light rounded m-1 p-2 d-block shadow">
            ...
            <div className="row">
                <div className="col">
                    <a role="button" className="btn btn-info w-100 mb-3" href="portfolio.html">Projects</a>
                </div>
            </div>
            <div className="row">
                <div className="col">
                    <a role="button" className="btn btn-info w-100" href="contact.html">Contact Me!</a>
                </div>
            </div>
        </div>
    )
